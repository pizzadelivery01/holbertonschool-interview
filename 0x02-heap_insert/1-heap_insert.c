 ...
 * @h_queue: pointer to the first item in queue
...
/**
 * swap - swaps the new node's value with it's parent's value
 * @new: new node to swap value with
 *
